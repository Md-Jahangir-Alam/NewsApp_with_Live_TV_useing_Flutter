              ...
              children: [
                ...
                Container(
                  ...
                  child: GridView.builder(
                      scrollDirection: Axis.vertical,
                      itemCount: news.sportsnews.length ?? 0,
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1), itemBuilder: (context, index){
                    return GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>newsDetelis(newsdetelis: news.sportsnews[index],)));
                      },
                      child: Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: NetworkImage(news.sportsnews[index]["urlToImage"]??"https://cdn.pixabay.com/photo/2022/06/20/17/17/mountain-7274247_960_720.jpg"),
                                        fit: BoxFit.cover)),
                              ),
                            ),
                            Container(
                              child: Center(
                                  child: Text(
                                    news.sportsnews[index]["title"]??"Loading...",
                                    style: TextStyle(
